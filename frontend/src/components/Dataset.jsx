...
export default function Dataset({ stats, onStatsUpdate, onNotification }) {
  ...
  const handleImport = async () => {
    ...
    try {
      const response = await fetch('/api/import/jsonl', {
        method: 'POST',
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      const response = await fetch(`/api/sample/${selectedSample.id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          id: editedSample.id,
  ...
  const handleDownloadSample = () => {
    ...
    window.open(`/api/sample/${selectedSample.id}/download`, '_blank')
  }
  ...
  const handleDownloadSelected = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/samples/download', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
